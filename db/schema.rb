...
ActiveRecord::Schema.define(version: 20_200_427_121_955) do
  ...
  create_table 'queries', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[case province locality benefit], name: 'index_queries_on_case_and_province_and_locality_and_benefit', unique: true
  end
  ...
  create_table 'query_results', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[query_id result_id], name: 'index_query_results_on_query_id_and_result_id', unique: true
  ...
  create_table 'results', force: :cascade do |t|
    ...
    t.index %w[benefit provider place address], name: 'index_results_on_benefit_and_provider_and_place_and_address', unique: true
  end
  ...
  create_table 'user_queries', force: :cascade do |t|
    ...
    t.index %w[user_id query_id], name: 'index_user_queries_on_user_id_and_query_id', unique: true
